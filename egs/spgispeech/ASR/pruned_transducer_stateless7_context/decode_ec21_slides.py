...
def decode_one_batch(
    ...
    if not model.no_encoder_biasing:
        encoder_biasing_out, attn = model.encoder_biasing_adapter.forward(encoder_out, contexts_h, contexts_mask, need_weights=False)
...
def decode_dataset(
    ...
    get_topk_hyps = None  # None means "all", False means False, an integer x means top-x
