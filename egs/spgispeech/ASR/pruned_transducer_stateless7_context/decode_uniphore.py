...
def main():
    ...
    test_healthcare_cuts = to_lower_case(uniphore.test_healthcare_cuts())
    test_banking_cuts = to_lower_case(uniphore.test_banking_cuts())
    test_insurance_cuts = to_lower_case(uniphore.test_insurance_cuts())
