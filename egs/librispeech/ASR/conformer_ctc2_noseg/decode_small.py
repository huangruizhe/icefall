...
from decode_oracle import decode_dataset_oracle_main
...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=False,
        help="""If True, it will decode with the factor transducer 
        of oracle transcripts.""",
    )
...
def main():
    ...
    for test_set, test_cut, test_dl in zip(test_sets, test_cuts, test_dl):
        if not params.oracle:
            ...
            save_results(params=params, test_set_name=test_set, results_dict=rs_train)
            save_results(params=params, test_set_name=test_set, results_dict=rs_eval)
