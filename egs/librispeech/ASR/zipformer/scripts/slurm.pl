...
# default gpu=0
# option gpu=0 -p defq
# option gpu=* -p a100 --gres=gpu:$0 -c $0  # Recommend allocating more CPU than, or equal to the number of GPU
...
# (e.g. --mem 2G) are converted to options to the SLURM system as defined in
