...
# exp_dir=/exp/rhuang/meta/icefall/egs/librispeech/ASR/pruned_transducer_stateless7_context_proxy/exp/exp_libri_100
# exp_dir=/exp/rhuang/meta/icefall/egs/librispeech/ASR/pruned_transducer_stateless7_context_proxy/exp/exp_libri  
exp_dir=/exp/rhuang/meta/icefall/egs/librispeech/ASR/pruned_transducer_stateless7_context_proxy/exp/exp_libri_proxy 
...
if true; then
    ...
    python /exp/rhuang/meta/icefall/egs/librispeech/ASR/pruned_transducer_stateless7_context_proxy/train.py \
      --world-size 4 \
      --use-fp16 true \
      ...
      --n-distractors $n_distractors  --start-epoch 31 --num-epochs 40 # --start-batch 24000 # --base-lr 0.08  --master-port 12355
fi
