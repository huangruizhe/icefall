...
exp_dir=/exp/rhuang/meta/icefall/egs/librispeech/ASR/pruned_transducer_stateless7_context_proxy/exp/exp_libri  # 11169231, 11169507, 11169508
# exp_dir=/exp/rhuang/meta/icefall/egs/librispeech/ASR/pruned_transducer_stateless7_context_proxy/exp/exp_libri_proxy  # 11169268 -- getting worse! :(
  ...
  for m in modified_beam_search ; do
    for epoch in $epochs; do
      for avg in $avgs; do
        ...
        ./pruned_transducer_stateless7_context_proxy/decode.py \
            --epoch $epoch \
            --avg $avg \
            --use-averaged-model $use_averaged_model \
            --exp-dir $exp_dir \
